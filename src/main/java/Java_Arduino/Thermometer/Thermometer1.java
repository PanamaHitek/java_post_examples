 ...
 */
public class Thermometer1 extends javax.swing.JFrame {
    ...
    public Thermometer1() {
        try {
            ...
            //Se establece el valor de la temperatura
            chart.setValue(40);         

            /**
             * Se crea la conexión con el puerto COM16 a 9600 baudios Arduino
             * debe estar configurado para enviar solamente datos de
             * temperatura, de lo contrario el software no sera capaz de
             * interpretar la información recibida
             */
            chart.createArduinoFollowUp("COM16", 9600);
        } catch (Exception ex) {
            Logger.getLogger(Thermometer1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Thermometer1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Thermometer1().setVisible(true);
            }
        });
    }
